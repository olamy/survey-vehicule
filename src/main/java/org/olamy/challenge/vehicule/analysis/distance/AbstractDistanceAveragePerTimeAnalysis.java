 ...
 *
 */
public abstract class AbstractDistanceAveragePerTimeAnalysis
    ...
    implements VehiculeRecordAnalysis
{
    ...
    public void displayResult( VehiculeRecordDataAccess vehiculeRecordDataAccess )
    {
        ...
        for ( Character direction : directions )
        {
            ...
            resultsPerDirection.put( direction, vehiculeRecordDataAccess.getDistanceAverages( increment, direction ) );
        }
